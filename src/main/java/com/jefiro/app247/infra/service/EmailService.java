...
public class EmailService {
    ...
    public void enviarEmail(ValidateCodeRequest passwordRecovery) throws Exception {
    ...
    public String gerarTemplate(ValidateCodeRequest recovery) {
                  ...
                  <div class="wrapper">
                    ...
                    <div class="card">
                      <div class="card-banner">
                        ...
                        <p>Precisamos verificar que este endereço<br>de e-mail pertence a você.</p>
                      </div>
                      <div class="card-body">
                        <p class="greeting">Olá, <strong>{{NOME}}</strong> 👋</p>
                        <p class="message">
                          Para ativar sua conta, use o código de verificação abaixo.
                          Ele deve ser inserido na tela de confirmação.
                        </p>
                        <div class="code-block">
                          <p class="code-label">Seu código de verificação</p>
                          <div class="code-value">{{CODE}}</div>
                          <p class="code-hint">Digite este código na tela de verificação.</p>
                        </div>
                        <div class="expiry">
                          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <circle cx="12" cy="12" r="10"/>
                        ...
                        <div class="warning">
                          <p>
                            <strong>Não solicitou isso?</strong> Você pode ignorar este e-mail com segurança.
                            Sua conta permanece inativa até que o e-mail seja confirmado.
                          </p>
                        </div>
                      </div>
                      <div class="card-footer">
